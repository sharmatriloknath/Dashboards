...
class StockPickingType(models.Model):
    ...
    code = fields.Selection(selection_add=[('mrs_operation', 'Mrs Operation')])
...
class Picking(models.Model):
    ...
    job_challan_id = fields.Many2one('mrp.challan','Job Challan')
    gatepass_out_id = fields.Many2one('mrp.challan.gatepass.out', 'Gate Out Challan')
